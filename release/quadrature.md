...
`PASS` (run `1654a9b`). ggen renders. Lean admits. mfact certifies.
...
| C2: procint corpus: 153 kernel-admitted, axiom-audited theorems | `release/release-manifest.json#artifacts` |
...
- TTL catalog: 153 proven declarations
