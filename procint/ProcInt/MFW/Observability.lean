...
/-- **Conjecture (Zero Residual → Sufficiency).**
...
Standing: CONJECTURAL — requires the measure-theoretic bridge between zero
conditional mutual information and deterministic factorization. -/
