...
\begin{center}\itshape generated/quadrature.tex not rendered.\end{center}}
...
We have described \textsf{mfact} as a small Lean~4 framework for receipted
mathematical manufacturing and \textsf{procint} as its first manufactured
domain. The central claim is not that generation is trustworthy. The
central claim is the opposite: generation is untrusted, and therefore
mathematical standing must be manufactured through explicit admission,
refusal, audit, manifest, and replay.
...
\textsf{procint} demonstrates this discipline on process intelligence:
Petri nets, workflow nets, conformance, event logs, and OCEL-style
object-centric logs. The domain matters because process intelligence is
itself about standing: what happened, what conformed, what failed, what
object relations were involved, and what evidence supports the claim.
\textsf{mfact} applies the same logic to mathematics. It manufactures not
syntax, but standing.

The broader result is a bounded response to the problem of generated
formal content. Rice-style undecidability is not denied. Instead,
arbitrary semantic judgment is replaced by declared admission inside a
replayable boundary. Contact is not consequence; candidate generation is
not proof; compilation is not full standing; and prose is not receipt. A
