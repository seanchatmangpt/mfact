...
Generation & \textsf{ggen} SPARQL-in-Tera templates \\
...
\item \textbf{Build:} \texttt{lake build} in \texttt{mfact/} and
  \texttt{procint/}.
\item \textbf{Generation:} \texttt{ggen sync run} against
  \texttt{packs/lean-math-pack} and the merged \texttt{procint:} ontology.
