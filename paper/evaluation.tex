...
Metric & Value \\
\midrule
Lines of Lean (\texttt{ProcInt/}) & 22{,}217 \\
Declarations recorded in the ontology & 401 \\
Modules & 53 \\
Theorems kernel-admitted and axiom-audited (\emph{proven}) & 203 \\
Statements formalized but not discharged (\emph{stated}) & 2 \\
Definitions, structures, and test oracles & 196 \\
\bottomrule
\end{tabular}
...
\texttt{Classical.choice}, \texttt{Quot.sound}, \texttt{propext} & 112 \\
\midrule
Total proven & 203 \\
...
\bottomrule
\end{tabular}
\caption{Axiom-audit result over all 203 proven theorems. Every set is a
...
genesis-folded release hash (BLAKE3, folded over all 401 artifact hashes
in name order, seed \texttt{"mfact-v26.7.13-genesis"}) is
\texttt{74900dc3...521f32} (truncated; full value in
