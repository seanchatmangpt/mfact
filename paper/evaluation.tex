% GENERATED from /Users/sac/mfact/release/release-manifest.json,
% /Users/sac/mfact/release/gates.json, and `git log` on this repository.
% Extraction commands:
...
Metric & Value \\
\midrule
Lines of Lean (\texttt{ProcInt/}) & 4{,}274 \\
Declarations recorded in the ontology & 318 \\
Modules & 50 \\
Theorems kernel-admitted and axiom-audited (\emph{proven}) & 145 \\
Statements formalized but not discharged (\emph{stated}) & 2 \\
Definitions, structures, and test oracles & 171 \\
\bottomrule
\end{tabular}
...
No axioms & 37 \\
\texttt{propext} & 28 \\
\texttt{propext}, \texttt{Quot.sound} & 25 \\
\texttt{propext}, \texttt{Classical.choice}, \texttt{Quot.sound} & 55 \\
\midrule
Total proven & 145 \\
...
\bottomrule
\end{tabular}
\caption{Axiom-audit result over all 145 proven theorems. Every set is a
...
genesis-folded release hash (BLAKE3, folded over all 318 artifact hashes
in name order, seed \texttt{"mfact-v26.7.6-genesis"}) is
\texttt{a138ee84...79fd86} (truncated; full value in
