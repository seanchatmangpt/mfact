...
Metric & Value \\
\midrule
Lines of Lean (\texttt{ProcInt/}) & 6{,}711 \\
Declarations recorded in the ontology & 333 \\
Modules & 51 \\
Theorems kernel-admitted and axiom-audited (\emph{proven}) & 153 \\
Statements formalized but not discharged (\emph{stated}) & 2 \\
Definitions, structures, and test oracles & 178 \\
\bottomrule
\end{tabular}
...
\texttt{Classical.choice}, \texttt{Quot.sound}, \texttt{propext} & 62 \\
\midrule
Total proven & 153 \\
...
\bottomrule
\end{tabular}
\caption{Axiom-audit result over all 153 proven theorems. Every set is a
...
genesis-folded release hash (BLAKE3, folded over all 333 artifact hashes
in name order, seed \texttt{"mfact-v26.7.6-genesis"}) is
\texttt{a61fe6f5...2d768d} (truncated; full value in
