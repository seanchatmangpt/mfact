...
Metric & Value \\
\midrule
Lines of Lean (\texttt{ProcInt/}) & 10{,}152 \\
Declarations recorded in the ontology & 388 \\
Modules & 52 \\
Theorems kernel-admitted and axiom-audited (\emph{proven}) & 197 \\
Statements formalized but not discharged (\emph{stated}) & 2 \\
Definitions, structures, and test oracles & 189 \\
\bottomrule
\end{tabular}
...
genesis-folded release hash (BLAKE3, folded over all 388 artifact hashes
in name order, seed \texttt{"mfact-v26.7.6-genesis"}) is
\texttt{b29ffd32...843465} (truncated; full value in
