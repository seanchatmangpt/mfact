...
Metric & Value \\
\midrule
Lines of Lean (\texttt{ProcInt/}) & 7{,}204 \\
Declarations recorded in the ontology & 340 \\
Modules & 51 \\
Theorems kernel-admitted and axiom-audited (\emph{proven}) & 160 \\
...
\texttt{Classical.choice}, \texttt{Quot.sound}, \texttt{propext} & 69 \\
\midrule
Total proven & 160 \\
...
\bottomrule
\end{tabular}
\caption{Axiom-audit result over all 160 proven theorems. Every set is a
...
genesis-folded release hash (BLAKE3, folded over all 340 artifact hashes
in name order, seed \texttt{"mfact-v26.7.6-genesis"}) is
\texttt{d33e8c3d...21bd9d} (truncated; full value in
