...
its current standing is \texttt{REPLAY\_NOT\_RUN}. The
gate clones the repository at tag \texttt{v26.7.13-procint-certified}
into a scratch tree and re-runs the manufacturing rail there:
\begin{enumerate}
  \item \texttt{git clone \textless stand-in\textgreater /mfact-dryrun.git at tag v26.7.13-procint-certified}
